...
<div class="container-fluid">
    <body>
        ...
        <form action="update-name.php" method="POST" class="">
                <p class="text-center"><input type="text" name="nombre" value="<?php print $arry[1]; ?>" class="col-6 mb-3 mt-2" ><br>
...
<?php
    ...
    $name = $_POST['nombre'];
    $id = $arry[0];
    $query = $mbd -> prepare("UPDATE registro SET name = :name WHERE id = :id ");
